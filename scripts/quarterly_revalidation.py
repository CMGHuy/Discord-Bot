...
def refresh_cache() -> None:
    ...
    subprocess.run([sys.executable, "scripts/fetch_backtest_data.py", "--force"],
                   cwd=ROOT, check=True)
...
def run_full_system_and_permutation(permutation_n: int) -> dict:
    ...
    wf = subprocess.run([sys.executable, "scripts/wf_run.py", "--full", "--portfolio",
    ...
    perm = subprocess.run([sys.executable, "scripts/permutation_test.py",

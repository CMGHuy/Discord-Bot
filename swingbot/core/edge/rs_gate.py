...
gate only ever blocks bearish setups. See docs/strategy/strategy-gates.md's RS gate section.
...
a real reading, not as exempt; see docs/strategy/strategy-gates.md.)

...
COMMANDS_BY_CATEGORY = {
    ...
    "📊 Trades & performance": [
        ...
        ("!liveplans [status] [level:1-5] [badge:validated|weak] [TICKER]",
         "Live ranked plan board (PENDING/ACTIVE/PARTIAL), filterable and paginated via buttons. Filters compose: status/level/badge/ticker."),
    ],
    "📐 Analytics": [
        ("!top [n]", "The n highest follow-score PENDING/ACTIVE plans right now (default: DIGEST_MAX_PLANS)"),
        ("!stats [7d|30d|90d|ytd|all]", "Win rate, expectancy, profit factor, Sharpe/Sortino, max drawdown, by-confidence-level and by-strategy breakdowns"),
        ("!lessons [n|week]", "Last n journal entries with their auto-generated lesson, or `week` for the weekly digest"),
        ("!calibration", "Confidence-level calibration, quality-score deciles, and edge-decay alerts"),
...
COMMAND_USAGE = {
    ...
    "liveplans":           ("!liveplans [status] [level:1-5] [badge:validated|weak] [TICKER]",
                            "!liveplans  or  !liveplans active level:5 NVDA"),
    # Analytics

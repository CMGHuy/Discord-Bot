# Gatekeeper v6 - Part 5/11: Checklist engine II: the 9 red flags (section 3) (Tasks G57-G67)
...
>
> **Split note:** this is part 5 of 11, extracted verbatim from the pre-split master plan (deleted 2026-07-26, see the part index; the checklist-to-task traceability appendix is in Part 11). Parts execute in numeric order.

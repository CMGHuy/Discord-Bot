...
**Goal:** Cut the per-change cost of the **1145-test** suite along both axes — wall-clock (180s → ~40-60s gate, ~27s inner loop) and agent context (hundreds/thousands of tokens per run → ~50) — per `docs/superpowers/specs/implemented/2026-08-07-v7-test-cost-reduction-design.md`.

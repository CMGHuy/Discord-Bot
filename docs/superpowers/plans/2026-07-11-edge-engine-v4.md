...
- **Next:** Task E33 (Fold-tune the Phase-E2 filter set) — but note its own ordering note: E33 EXECUTES AFTER E39 (the fold engine). Build E34–E39 first, then come back to E33.

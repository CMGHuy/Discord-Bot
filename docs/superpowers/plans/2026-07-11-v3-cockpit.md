...
**Prerequisite:** Unified Plan Engine v2 (`docs/superpowers/plans/2026-07-11-v2-unified-plan-engine.md`) fully implemented: `plan_engine.TradePlanV2`, `quality.py` scores wired, `registry.get_badge`, `plan_store.PlanStore`, `plan_manager.PlanManager`, two-leg trades.json schema.
...
```bash
git add tests/test_analytics_perf.py README.md docs/superpowers/plans/2026-07-11-v3-cockpit.md
...
```bash
git add docs/superpowers/plans/2026-07-11-v3-cockpit.md
...
```bash
git add docs/superpowers/plans/2026-07-11-v3-cockpit.md README.md DOCKER.md

...
- [ ] **Step 6: Part 12 checkpoint.** Both carry-over docs committed (`2026-07-gate-carryover-e2v2.md`, `2026-07-gate-carryover-cockpit.md`). Update this part's Progress block (Completed: G217-G218) and mirror into `2026-07-14-gatekeeper-v6_0-index.md`'s status table (Part 12 row: not started → done).

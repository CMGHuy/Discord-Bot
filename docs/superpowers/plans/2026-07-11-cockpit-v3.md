...
> - **Completed:** Tasks A1-A31 — **Plan A (Part 1, Analytics & Insight Core) done.** Plan B: Tasks B1-B5 (embed theme module, themed build_embed, compact/detailed layouts, trigger-aware explanations, alerts ranked by follow_score).
> - **Next:** Task B6
